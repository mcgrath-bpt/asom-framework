...
SERVICENOW_INTERACTION_MODEL.md
...
Key principle:
ASOM reads ServiceNow.
ServiceNow authorises change.
ASOM never replaces or bypasses SNOW.
...
✅ SERVICENOW_INTERACTION_MODEL.md — COMPLETE
